...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/01-initial-state.png

## Load real progress-ring doc — PASS
- Tested:   cleared JSON editor, filled with contents of `<repo>/sketches/progress-ring/ring.glam` (canvas 360x360, bg #0e1014, 12 dots + track + core, progress=0.66).
...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/02-ring-loaded.png
...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/05-tab-webcomponent.png
...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/03-tab-javascript.png
...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/04-tab-react.png
...
- Evidence: <repo>/docs/superpowers/qc/evidence/studio-use-panel/06-copy-confirmation.png
